...
<!-- BEGIN PAGE LEVEL STYLES -->
<link href="<?= base_url() ?>/assets/global/plugins/nouislider/jquery.nouislider.min.css" rel="stylesheet" type="text/css"/>
<link href="<?= base_url() ?>/assets/global/plugins/nouislider/jquery.nouislider.pips.min.css" rel="stylesheet" type="text/css"/>
<!-- END PAGE LEVEL STYLES -->
<!-- BEGIN THEME STYLES -->
			...
			<div class="row margin-top-10">
				<div class="col-md-12">
					...
					<div class="row">
						...
						<div class="col-md-9">
							<h6><em><?= $num_doctors ?> 
							<?php if($num_doctors <= 1): ?> match
							<?php else: ?> matches
							<?php endif; ?>
							found for <?= $search_subject . 's' ?> in Cebu City</em></h6>
						</div>
					</div>
							...
							<div class="col-md-3">
								...
								<div class="portlet light">
									<div class="portlet-title">
										<div class="caption">
											<span class="caption-subject font-green-sharp bold uppercase">Search Doctors by</span>
										</div>
									...
									<div class="portlet-body">
										<div class="tabbable-line">
											<ul class="nav nav-tabs">
												<li class="active"><a href="#tab1" data-toggle="tab" aria-expanded="true">Doc Info</a></li>
												<li class><a href="#tab2" data-toggle="tab" aria-expanded="true">Doctor Name</a>
											</ul>
													...
													<form role="form" method="GET" action="<?= base_url(). 'dir/search' ?>">
														<div class="form-body">
															<div class="form-group">
																<input name="booking" type="checkbox" value="1"> w/ Online Booking
															</div>
															<div class="form-group">
															...
															<div class="form-group">
																<label><b>Hospital/Institution</b></label>
																<select name="hospital" class="form-control">
																	<option value="0">Any</option>
																	<?php foreach($hospitals as $hospital): ?>
																		<option value="<?= $hospital->hosp_id ?>"
																			<?php if($this->input->get('hospital') == $hospital->hosp_id) echo 'selected'; ?>>
																			<?= $hospital->hosp_name ?>
																		</option>
																	<?php endforeach; ?>
																</select>
															...
															<div class="form-group">
																...
																<div class="clearfix">
																	<div class="btn-group btn-group-sm" data-toggle="buttons">
																		...
																		<input type="checkbox" class="toggle" value="any" name="day[]"> Any </label>
																		<label class="btn default">
																		<input type="checkbox" class="toggle" value="mon" name="day[]"> M</label>
																		<label class="btn default">
																		<input type="checkbox" class="toggle" value="tue" name="day[]"> T </label>
																		<label class="btn default">
																		<input type="checkbox" class="toggle" value="wed" name="day[]"> W </label>
																		<label class="btn default">
																		<input type="checkbox" class="toggle" value="thu" name="day[]"> T </label>
																		<label class="btn default">
																		<input type="checkbox" class="toggle" value="fri" name="day[]"> F </label>
																		<label class="btn default">
																		<input type="checkbox" class="toggle" value="sat" name="day[]"> S </label>
																		<label class="btn default">
																		<input type="checkbox" class="toggle" value="sun" name="day[]"> S </label>
																	</div>
																</div>
															</div>
															<!-- <div class="form-group">
														...
														<div class="form-body">
															<div class="form-group">
																<label><b>Name</b></label>
																	<input type="text" name="name" class="form-control" placeholder="e.g. Mariano Torres">
															</div>
															<div class="form-actions">
																<button type="submit" class="btn blue">Search</button>
															</div>
									...
									<div class="portlet-body">
											<?php if(empty($doctors)): ?>
												<div class="text-center"?>
													...
													<h4>We're adding new doctors so try your search again soon!</h4>
												</div>
											<?php endif; ?>
											<?php foreach ($doctors as $doctor): ?>
												<div><!-- 1 doctor -->
													<div class="row">
														<div class="col-md-3">
															<!-- Doctor image here -->
															<img class="img-responsive" src="<?= base_url('uploads/doc_images/'. $doctor->img_file_name) ?>"></img>
														</div>
														<div class="col-md-5">
															<?php $profile_url = base_url() . 'dir/doctor/'. $doctor->doc_longname ?>
															<a href="<?= $profile_url ?>"><h4><strong>Dr. <?= $doctor->doc_fname . ' ' . $doctor->doc_lname ?></strong></h4></a>
															<h5><strong><?= $doctor->spec_name ?></strong></h5>
															<h6>10 years experience</h6>
															<div>
																<div class="row">
																	<div class="col-md-12">	
																		<h5><i class="fa fa-hospital-o"></i><strong>&nbsp;Clinics</strong></h5>
																	</div>
																</div>
																<ul>
														...
														<div class="col-md-4">
															<div class="row">
																<h4>
																	...
																	<i class="fa fa-star font-yellow"></i>
																	<i class="fa fa-star font-yellow"></i>
																	<!-- <i class="fa fa-thumbs-up"></i>&nbsp;<strong>423</strong> Recommendations -->
																</h4>
															</div>
															<div>
																<div class="row">
																	<h5>
																	<i class="fa fa-clock-o" style="height: 40; width: 40"></i><!-- <h5><strong>Schedule</strong></h5> -->
													...
													<div class="row">
														<div class="col-md-3"></div>
														<div class="col-md-5">
															<?php if($doctor->doc_has_booking): ?>
																<a href="<?= base_url() ?>"><button class="btn green" type="button">Book Appointment</button></a>
															<?php endif; ?>
														</div>
														<div class="col-md-4">
															<a href="<?= $profile_url ?>"><button class="btn blue" type="button">View Profile</button></a>
														</div>
													</div>
												</div>
												<hr/>
