...
<div class="content" style="margin-top:-50px;">
	<form class="register-form" action="<?=base_url();?>auth/change_doctor_pass" method="post" style="display:inline">
		...
		<div class="form-group">
			...
			<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="<?= $this->session->userdata('change_pass_email');?>" name="defined_email" readonly/>
		</div>		
		<div class="form-group">
