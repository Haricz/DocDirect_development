									...
									<div class="portlet-body">
										<div class="tab-content">
											...
											<div class="tab-pane active" id="tab_1_1">
												<?php if(!is_null($this->session->flashdata('success_msg'))): ?>
													<div class="alert alert-success">
														<?= $this->session->flashdata('success_msg'); ?>
													</div>
												<?php endif; ?>
												<form role="form" method="POST" action="<?= base_url('user/save_edits') ?>">
													<input type="hidden" name="gu_id" value="<?= $this->session->userdata('acc_id') ?>"/>
													<div class="form-group">
														<label class="control-label">First Name</label>
														<input type="text" class="form-control" name="firstname" value="<?= $gu->gu_firstname ?>" />
													</div>
													<div class="form-group">
														<label class="control-label">Last Name</label>
														<input type="text" class="form-control" name="lastname" value="<?= $gu->gu_lastname ?>" />
													</div>
													<div class="form-group">
														<label class="control-label">Mobile Number</label>
														<input type="text" class="form-control" name="mobile_no" value="<?= $gu->gu_mobile_no ?>"/>
													</div>
													<div class="form-group">
														<label class="control-label">Email</label>
														<input type="text" class="form-control" name="email" value="<?= $gu->gu_email ?>"/>
													</div>
													<div class="form-group">
														<label class="control-label">Gender</label>
														<select name="gender" class="form-control">
															<?php if(is_null($gu->gu_gender)): ?>
													...
													<!-- <div class="form-group">
														...
														<input type="text" placeholder="ex. 02/11/1995" class="form-control"/>
													</div> -->
													<div class="margiv-top-10">
														<button type="submit" class="btn green-haze">Save Changes</button>
														<a href="<?= base_url('user/edit_profile') ?>" class="btn default">
														Cancel </a>
													</div>
												</form>
											</div>
											...
											<div class="tab-pane" id="tab_1_3">
												...
												<?php endif; ?>
												<form action="<?= base_url('user/save_password_edits') ?>" method="POST">
													<div class="form-group">
														<label class="control-label">Current Password</label>
														<input type="password" name="curr_pw" class="form-control"/>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<input type="password" name="new_pw2" class="form-control"/>
													</div>
													<div class="margin-top-10">
														<button type="submit" class="btn green-haze">Change Password</button>
														<a href="<?= base_url('user/') ?>" class="btn default">
														Cancel </a>
													</div>
												</form>
											</div>
