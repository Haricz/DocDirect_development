...
<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/custom/jquery.timepicker.css"/>
				...
				<div class="portlet box blue ">
					...
					<div class="portlet-body form">
						...
						<form name="doctorForm" method="post" action="add_doctor_page">
							...
							<div id="form_modal_hospital" class="modal fade" tabindex="-1" data-width="400">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
										...
										<div class="modal-body">
											<div class="form-horizontal">
												<div class="form-group">
													...
													<select name="doc_hospital" id="doc_hospital"  class="form-control select2_sample1" placeholder="Choose a hospital" style="display:inline-block;width:250px;">	
												...
												<div class="form-group">
													<label class="control-label col-md-4">Room</label>													
														<input type="text" id="doc_room" class="form-control" placeholder="ex. 213-B"  style="text-align:center;width:250px;">
												</div>		
												<div class="form-group">
													<label class="control-label col-md-4">Contact Number</label>				
														<input type="text" id="doc_contact_num" class="form-control" placeholder="ex. 4167213"  style="text-align:center;width:250px;">								
												</div>		
												<p style="margin-left:3px;font-weight:bold;font-style:italic;font-size:11px;">Please add the office's schedule after submitting</p>	
												<div class="schedule">
												</div>
										...
										<div class="modal-footer"><br>
											<button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
											<button class="btn green btn-primary" id="add_hospital" data-dismiss="modal">Add</button>
									...
									<div class="form-body">
										<div class="form-group">
											<div id="hospital">	
												...
												<div style="text-align:right;">                                          
													<a class="btn yellow" href="#form_modal_hospital" data-toggle="modal" style="margin:0px auto;width:160px;">Add Hospital&nbsp;<i class="fa fa-plus"></i></a>														
												</div>		
										</div>							
										<br/>
									</div>

								<input type="text" class="form-control timepicker timepicker-no-seconds" style="display:inline-block;width:85px;text-align:center;font-size:13px;">
							</div>
...
<script type="text/javascript" src="<?= base_url() ?>js/jquery.timepicker.js"></script>
